...
export default function JournalPage() {
    ...
    const loadJournals = async (silent = false) => {
        if (silent) {
            setRefreshing(true);
        } else {
            setLoading(true);
    ...
    const createJournal = async () => {
        ...
        showMessage(
            "Tumhari baat Journal mein share ho gayi. ❤️",
            "success"
        );
    };
    ...
    // ⭐ NEW: Reload comments immediately
    await loadComments();
    ...
    const getComments = (journalId: string) => {
        ...
        <main className="min-h-screen bg-black text-white">
            ...
            <div
                className="
                    ...
                    fixed
                    inset-0
                    bg-[radial-gradient(circle_at_50%_15%,rgba(80,90,120,0.16),transparent_48%)]
                "
            />
